...
class analyzerMainWindow(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        # Defining variables
        self.rawA1 = np.zeros(1)
        self.rawA2 = np.zeros(1)
        self.section1 = np.zeros(1)
        self.section2 = np.zeros(1)
        self.sectionAve = np.zeros(1)
        self.sectionButter = np.zeros(1)
        self.section01 = np.zeros(1)
        self.section02 = np.zeros(1)
        self.D = 4.5  # Distance between two sensors
        ...
        self.wp2 = 0.0
        self.tp2 = 0.0
        self.filterCoreSize1 = 1000
        self.filterCoreSize2 = 1000
        self.butter_a = 0.0
        self.butter_b = 0.0
        self.tf = 0.0
        self.vs = 0.0
        ...
        self.filterLabel1 = QtGui.QLabel('low pass limit (kHz)')
        ...
        self.filterLabel2 = QtGui.QLabel('low pass limit (kHz)')
    ...
    def keyPressEvent(self, e):
        ...
        # W key writes output, export image, and quit
        ...
        # arrow keys changing low pass filter limit (for both channels):
        # up/down, increase/decrease core size by 100, or 10, or 1, depending on the current limit
        if e.key() == QtCore.Qt.Key_Up:
            if (self.filterCoreSize1>=500):
                self.filterCoreSize1 = 1000
                self.filterCoreSizeBox1.setText('%d' % self.filterCoreSize1)
                self.analyzePeak1()
            else:
                self.filterCoreSize1 = self.filterCoreSize1 + pow(10,int(np.log10(self.filterCoreSize1)))
                self.filterCoreSizeBox1.setText('%d' % self.filterCoreSize1)
                self.analyzePeak1()
                
            if (self.filterCoreSize2>=500):
                self.filterCoreSize2 = 1000
                self.filterCoreSizeBox2.setText('%d' % self.filterCoreSize2)
                self.analyzePeak2()
            else:
                self.filterCoreSize2 = self.filterCoreSize2 + pow(10,int(np.log10(self.filterCoreSize2)))
                self.filterCoreSizeBox2.setText('%d' % self.filterCoreSize2)
                self.analyzePeak2()
                
        if e.key() == QtCore.Qt.Key_Down:
            if (self.filterCoreSize1<=2):
                self.filterCoreSize1 = 1
                self.filterCoreSizeBox1.setText('%d' % self.filterCoreSize1)
                self.analyzePeak1()
            elif (self.filterCoreSize1 > 500):
                self.filterCoreSize1 = 500
                self.filterCoreSizeBox1.setText('%d' % self.filterCoreSize1)
                self.analyzePeak1()                
            else:
                self.filterCoreSize1 = self.filterCoreSize1 - pow(10,int(np.log10(self.filterCoreSize1*9.999/11.0)))
                self.filterCoreSizeBox1.setText('%d' % self.filterCoreSize1)
                self.analyzePeak1()
                
            if (self.filterCoreSize2<=2):
                self.filterCoreSize2 = 1
                self.filterCoreSizeBox2.setText('%d' % self.filterCoreSize2)
                self.analyzePeak2()
            elif (self.filterCoreSize2 > 500):
                self.filterCoreSize2 = 500
                self.filterCoreSizeBox2.setText('%d' % self.filterCoreSize2)
                self.analyzePeak2() 
            else:
                self.filterCoreSize2 = self.filterCoreSize2 - pow(10,int(np.log10(self.filterCoreSize2*9.999/11.0)))
                self.filterCoreSizeBox2.setText('%d' % self.filterCoreSize2)
                self.analyzePeak2()
    ...
    def imgExport(self):       
        ...
        if self.intLevelNo is 0:
            ...
            #self.updatePlotYMin() #Comment to enable fixed y range, uncomment to disable
            #self.updatePlotYMax() #Comment to enable fixed y range, uncomment to disable
    ...
    def writeOut(self):
        ...
        self.an.filterCoreSize1 = self.filterCoreSize1
    ...
    def updateFilterCoreSize1(self):
        if float(self.filterCoreSizeBox1.text()) > 1000:
            print("Low pass limit must be less than 1MHz!")
            self.filterCoreSize1 = 1000
            self.filterCoreSizeBox1.setText('%d' % 1000)
        elif float(self.filterCoreSizeBox1.text()) < 1:
            print("Low pass limit must be larger than 1kHz!")
            self.filterCoreSize1 = 1
            self.filterCoreSizeBox1.setText('%d' % 1)
        else:
            self.filterCoreSize1 = int(float(self.filterCoreSizeBox1.text()))
            
    def updateFilterCoreSize2(self):
        if float(self.filterCoreSizeBox2.text()) > 1000:
            print("Low pass limit must be less than 1MHz!")
            self.filterCoreSize2 = 1000
            self.filterCoreSizeBox2.setText('%d' % 1000)
        elif float(self.filterCoreSizeBox2.text()) < 1:
            print("Low pass limit must be larger than 1kHz!")
            self.filterCoreSize2 = 1
            self.filterCoreSizeBox2.setText('%d' % 1)
        else:
            self.filterCoreSize2 = int(float(self.filterCoreSizeBox2.text()))
        
    """ filter coresize update functions used for running average
    ...
    def butterLowpassFilter1(self):
        self.butter_b,self.butter_a = butter(5, self.filterCoreSize1*1000/(0.5*self.f), btype='low', analog=False)
        self.sectionButter = lfilter(self.butter_b, self.butter_a, self.section1)
        self.section1 = list(self.sectionButter)

    def butterLowpassFilter2(self):
        self.butter_b,self.butter_a = butter(5, self.filterCoreSize2*1000/(0.5*self.f), btype='low', analog=False)
        self.sectionButter = lfilter(self.butter_b,self.butter_a,self.section2)
        self.section2 = list(self.sectionButter)
    ...
    def analyzePeak1(self):
        ...
        self.pw2.removeItem(self.plot6)
        self.pw2.removeItem(self.plot9)
        if self.filterCoreSize1 == 1000:
            self.section1 = list(self.rawA1[self.imin1:self.imax1])
        else:
    ...
    def analyzePeak2(self):
        ...
        self.pw2.removeItem(self.plot8)
        self.pw2.removeItem(self.plot10)
        if self.filterCoreSize2 == 1000:
            self.section2 = list(self.rawA2[self.imin2:self.imax2])
        else:
            #medfilt defined in scipy
            #self.section2 = signal.medfilt(self.rawA2[self.imin2:self.imax2],
            #                               self.filterCoreSize2)
            self.section2 = list(self.rawA2[self.imin2:self.imax2])
            self.butterLowpassFilter2()
        ...
        for i in range(0, self.ipeak2):
            if self.section2[i] >= self.Ap2*0.2+self.avg2: #0.1 0.2 or 0.5
                break
        self.iFrontHM2 = i
        ...
        self.plot10 = self.pw2.plot([self.tp2, self.ipeak2/1000.0+self.min2, self.tp2+self.wp2],[self.Ap2*0.2+self.avg2, self.Ap2+self.avg2, self.Ap2*0.2+self.avg2], pen=None, symbolBrush=('m'), symbolSize=7)
